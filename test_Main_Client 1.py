...
user_ApolloWebPortalListVar = ["demousg",
                               "demousg",
                               "demousg",
                               "demousg",
                               "demousg"]

password_ApolloWebPortalListVar = ["demousg",
                                   "demousg",
                                   "demousg",
                                   "demousg",
                                   "demousg"]
...
workOrder_Contacts_Var = "carlos.liguori@assuredtechmatics.com"
...
#    test_WorkOrder_ManagePage_apolloWebPortal.WorkOrder_ManagePage (driver, driver_Name, driver_Version, carrier, truckDriversList)
